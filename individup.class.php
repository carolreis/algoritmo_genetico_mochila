...
class Individuo {
	...
	public $espacos;
	public $valores;
	public $limite_espacos;
	public $nota_avaliacao;
	public $espaco_usado;
	public $geracao;
	public $cromossomo = array();

	function __construct($espacos, $valores, $limite_espacos, $geracao = 0, $cromossomo = array()) {
		$this->espacos = $espacos;
		$this->valores = $valores;
		$this->limite_espacos = $limite_espacos;
	...
	function avaliacao() {
		...
		if ($soma_espacos > $this->limite_espacos) {
			$nota = 1;			
		}
	...
	function crossover($outro_individuo) {
		...
		$filho1 = array_slice($outro_individuo->cromossomo, 0, $corte) + array_slice($this->cromossomo, $corte + 1);
		$filho2 = array_slice($this->cromossomo, 0, $corte) + array_slice($outro_individuo->cromossomo, $corte + 1);
